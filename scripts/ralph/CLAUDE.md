...
6. Run quality checks for the workspace(s) you touched — see the **Project: LinguaScrape** section below for the exact commands
...
## Project: LinguaScrape — Commands, Conventions & Gotchas
