...
A new feature has been added to LinguaScrape that enables computational analysis of linguistic similarity between languages using the ASJP-based LDND (Levenshtein Distance Normalized Divided) algorithm with phonetic feature-based weighting for improved accuracy.
