 ...
 *
 * Both are thin wrappers over the shared `getQueryFn` (client/src/lib/queryClient.ts):
 * the query keys built in `client/src/lib/progressive-loading.ts` map straight to
