...
:class:`~culturescrape.ontology.linker.Pipeline` threads *edges* through a chain
of linkers, but several linkers also mint nodes (places, periods, languages) or
rewrite an entity (the genetic linker's denormalized copy). The ``culturescrape
...
runs each linker's :meth:`~culturescrape.ontology.linker.Linker.link_full`,
...
Linkers run in the order :func:`~culturescrape.ontology.linker.Pipeline.from_registry`
...
def run_linkers(
    ...
    Each linker's :meth:`~culturescrape.ontology.linker.Linker.link_full` runs in
