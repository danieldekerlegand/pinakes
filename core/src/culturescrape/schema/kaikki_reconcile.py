...
* the **language coverage** of the ingested wordforms — reusing
  :func:`~culturescrape.schema.typology_reconcile.build_coverage`'s per-language
...
* the **edge volume** by canonical ``:TYPE`` plus every etymology-template token that
  ...
  extract with :func:`~culturescrape.schema.kaikki_etymology.extract_relations`, so
