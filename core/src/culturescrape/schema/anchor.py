...
There is **no live Getty endpoint** to query (see :mod:`culturescrape.acquire.getty`),
...
to mint name-anchored ids (:func:`culturescrape.schema.ids.normalize_name`), so
...
LOGGER = logging.getLogger("culturescrape.schema.anchor")
