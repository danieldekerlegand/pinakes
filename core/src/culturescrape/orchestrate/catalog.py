...
:func:`update_catalog` rebuilds the entries for one :class:`~culturescrape.
...
from culturescrape.ontology.metrics import UNKNOWN_DIMENSION, metrics_for_dataset

if TYPE_CHECKING:
    from culturescrape.orchestrate.jobs import Job
    from culturescrape.orchestrate.runner import CategoryRun, JobRun
