...
:class:`~culturescrape.acquire.records.RawRecord` per entry so kaikki joins the
...
* ``etymology_relations`` — the canonical etymology edges
  (:mod:`culturescrape.schema.kaikki_etymology`) extracted from the entry's
...
from culturescrape.schema.kaikki_etymology import extract_relations, relations_cell
