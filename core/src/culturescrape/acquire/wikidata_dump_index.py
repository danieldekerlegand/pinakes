...
#: Marks the database as a culture-scrape dump index (stored in ``meta`` and
...
def _read_meta(conn: sqlite3.Connection, index_file: Path) -> dict[str, str]:
    ...
    :class:`DumpIndexError` (e.g. the file is not a culture-scrape index)."""
    try:
