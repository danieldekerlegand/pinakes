...
:class:`~culturescrape.acquire.records.RawRecord` per canonical node / edge, so
...
:mod:`culturescrape.orchestrate.tiers`): the adapter stamps the acquisition source
:data:`INSIMUL_SOURCE`, which
:func:`~culturescrape.orchestrate.tiers.classify_tier` maps to
:data:`~culturescrape.orchestrate.tiers.TIER_SYNTHETIC`, and the per-record SPDX
...
(:func:`~culturescrape.orchestrate.tiers.assert_no_synthetic_records`) keeps those
...
if TYPE_CHECKING:  # pragma: no cover - types only
    from culturescrape.datalog.registry import RegistryEntry
...
#: synthetic tier (:data:`culturescrape.orchestrate.tiers.SYNTHETIC_SOURCES`).
...
#: :func:`culturescrape.datalog.registry.build_registry`.
...
def world_rule_entries(export: WorldExport) -> tuple[RegistryEntry, ...]:
    ...
    :func:`culturescrape.datalog.registry.build_registry` — the committed registry
    ...
    corpus with :func:`culturescrape.datalog.registry.write_registry`.
