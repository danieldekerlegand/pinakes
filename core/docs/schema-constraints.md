...
node. [`culturescrape.datalog.schema_constraints`](../src/culturescrape/datalog/schema_constraints.py)
...
`culturescrape schema-constraints <dataset> --baseline docs/schema-constraints-report.json`
