...
from culturescrape.acquire.wikidata_dump_adapter import WIKIDATA_ENTITY_PREFIX
...
def test_hydrate_unknown_profile_raises() -> None:
    from culturescrape.acquire.wikidata_hydration import UnknownProfileError
