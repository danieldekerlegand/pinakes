...
export class MemStorage implements IStorage {
  ...
  private initializeData() {
    ...
    // ============ INDO-EUROPEAN PHYLUM (2.91 billion speakers) ============
    ...
    const germanic: LanguageFamily = {
      ...
      name: "Germanic",
      parentId: "1",
      description: "Family including English, German, Dutch, and Scandinavian languages",
    ...
    const indoIranian: LanguageFamily = {
      ...
      name: "Indo-Iranian",
      parentId: "1",
      description: "Largest family of Indo-European including Hindi, Persian, Bengali",
      taxonomicLevel: "family",
    ...
    // ============ SINO-TIBETAN PHYLUM (1.27 billion speakers) ============
    const sinoTibetan: LanguageFamily = {
      id: "10",
      name: "Sino-Tibetan", 
      parentId: null,
      description: "Second largest phylum including Chinese languages and Tibeto-Burman",
      taxonomicLevel: "phylum",
    ...
    // ============ NIGER-CONGO PHYLUM (437 million speakers) ============
    const nigerCongo: LanguageFamily = {
      id: "13",
      name: "Niger-Congo",
      parentId: null,
      description: "Largest language phylum by number of languages, primarily in Sub-Saharan Africa",
      taxonomicLevel: "phylum",
    ...
    const bantu: LanguageFamily = {
      ...
      name: "Bantu",
      parentId: "13",
      description: "Largest family of Niger-Congo including Swahili, Zulu, Shona",
      taxonomicLevel: "family",
    ...
    // ============ AFROASIATIC PHYLUM (500+ million speakers) ============
    const afroasiatic: LanguageFamily = {
      id: "15",
      name: "Afroasiatic",
      parentId: null,
      description: "Ancient language phylum including Semitic, Berber, and Cushitic languages",
      taxonomicLevel: "phylum",
    ...
    // ============ AUSTRONESIAN PHYLUM (326 million speakers) ============
    const austronesian: LanguageFamily = {
      id: "17",
      name: "Austronesian",
      parentId: null,
      description: "Most geographically dispersed phylum, from Madagascar to Easter Island",
      taxonomicLevel: "phylum",
    ...
    const malayoPolynesian: LanguageFamily = {
      ...
      parentId: "17",
      description: "Largest family including Indonesian, Tagalog, Javanese, Hawaiian",
      taxonomicLevel: "family",
    ...
    const algic: LanguageFamily = {
      ...
      name: "Algic",
      parentId: null,
      description: "Major North American language phylum including Algonquian languages",
      taxonomicLevel: "phylum",
      estimatedOrigin: "North America",
      timeOrigin: "7000+ years ago",
    ...
    const algonquian: LanguageFamily = {
      ...
      name: "Algonquian",
      parentId: "26",
      description: "Largest family of Algic phylum",
      taxonomicLevel: "family",
      estimatedOrigin: "Eastern North America",
      timeOrigin: "3000+ years ago",
    ...
    const naDene: LanguageFamily = {
      ...
      name: "Na-Dené",
      parentId: null,
      description: "Major phylum including Athabaskan and Navajo-Apache languages",
      taxonomicLevel: "phylum",
      estimatedOrigin: "Western North America",
      timeOrigin: "10000+ years ago",
    ...
    const athabaskan: LanguageFamily = {
      ...
      name: "Athabaskan",
      parentId: "28",
      description: "Largest family of Na-Dené phylum",
      taxonomicLevel: "family",
      estimatedOrigin: "Alaska to Southwest US",
      timeOrigin: "4000+ years ago",
    ...
    const utoAztecan: LanguageFamily = {
      ...
      name: "Uto-Aztecan",
      parentId: null,
      description: "Large phylum from Western US to Central Mexico",
      taxonomicLevel: "phylum",
      estimatedOrigin: "Western North America",
      timeOrigin: "5000+ years ago",
    ...
    const iroquoian: LanguageFamily = {
      ...
      name: "Iroquoian",
      parentId: null,
      description: "Northeastern US and southeastern Canada phylum",
      taxonomicLevel: "phylum",
      estimatedOrigin: "Great Lakes region",
      timeOrigin: "4000+ years ago",
    ...
    const siouan: LanguageFamily = {
      ...
      name: "Siouan",
      parentId: null,
      description: "Great Plains and Ohio Valley phylum",
      taxonomicLevel: "phylum",
      estimatedOrigin: "Great Plains region",
      timeOrigin: "3000+ years ago",
    ...
    const mayan: LanguageFamily = {
      ...
      name: "Mayan",
      parentId: null,
      description: "Major Mesoamerican language phylum",
      taxonomicLevel: "phylum",
      estimatedOrigin: "Guatemala highlands",
      timeOrigin: "4000+ years ago",
    ...
    const quechuan: LanguageFamily = {
      ...
      name: "Quechuan",
      parentId: null,
      description: "Andean language phylum of the former Inca Empire",
      taxonomicLevel: "phylum",
      estimatedOrigin: "Central Andes",
      timeOrigin: "2000+ years ago",
    ...
    const arawakan: LanguageFamily = {
      ...
      name: "Arawakan",
      parentId: null,
      description: "Largest South American language phylum",
      taxonomicLevel: "phylum",
      estimatedOrigin: "Northern South America",
      timeOrigin: "3000+ years ago",
    ...
    const tupian: LanguageFamily = {
      ...
      name: "Tupian",
      parentId: null,
      description: "Large South American phylum including Guaraní",
      taxonomicLevel: "phylum",
      estimatedOrigin: "Amazon Basin",
      timeOrigin: "5000+ years ago",
    ...
    const eskimoAleut: LanguageFamily = {
      ...
      name: "Eskimo-Aleut",
      parentId: null,
      description: "Arctic language phylum",
      taxonomicLevel: "phylum",
      estimatedOrigin: "Arctic regions",
      timeOrigin: "6000+ years ago",
    ...
    const uralic: LanguageFamily = {
      ...
      name: "Uralic",
      parentId: null,
      description: "Northern Eurasian phylum including Finnish and Hungarian",
      taxonomicLevel: "phylum",
      estimatedOrigin: "Ural Mountains region",
      timeOrigin: "7000+ years ago",
    ...
    const finnic: LanguageFamily = {
      ...
      name: "Finnic",
      parentId: "38",
      description: "Baltic Finnic family",
      taxonomicLevel: "family",
      estimatedOrigin: "Baltic region",
      timeOrigin: "3000+ years ago",
    ...
    const transNewGuinea: LanguageFamily = {
      ...
      parentId: null,
      description: "Largest phylum in Papua New Guinea",
      taxonomicLevel: "phylum",
      estimatedOrigin: "New Guinea highlands",
      timeOrigin: "10000+ years ago",
    ...
    const niloSaharan: LanguageFamily = {
      ...
      name: "Nilo-Saharan",
      parentId: null,
      description: "Central and Eastern African language phylum",
      taxonomicLevel: "phylum",
      estimatedOrigin: "Eastern Sahara",
      timeOrigin: "10000+ years ago",
    ...
    const khoeKwadi: LanguageFamily = {
      ...
      name: "Khoe-Kwadi",
      parentId: null,
      description: "Southern African phylum including Khoikhoi languages",
      taxonomicLevel: "phylum",
      estimatedOrigin: "Southern Africa",
      timeOrigin: "8000+ years ago",
    ...
    const muskogean: LanguageFamily = {
      ...
      name: "Muskogean",
      parentId: null,
      description: "Southeastern United States language phylum including Choctaw, Creek, and Chickasaw",
      taxonomicLevel: "phylum",
      estimatedOrigin: "Southeastern United States",
      timeOrigin: "3000+ years ago",
    ...
    const siouanCatawban: LanguageFamily = {
      ...
      parentId: null,
      description: "Language phylum of the Great Plains and Eastern United States",
      taxonomicLevel: "phylum",
      estimatedOrigin: "Great Plains region",
      timeOrigin: "4000+ years ago",
    ...
    const caddoan: LanguageFamily = {
      ...
      name: "Caddoan",
      parentId: null,
      description: "Language phylum of the Great Plains",
      taxonomicLevel: "phylum",
      estimatedOrigin: "Great Plains",
      timeOrigin: "2500+ years ago",
      region: "Great Plains",
      totalSpeakers: 25,
      languageCount: 2,
    ...
    const keresan: LanguageFamily = {
      ...
      name: "Keresan",
      parentId: null,
      description: "Language isolate phylum of the Pueblo peoples",
      taxonomicLevel: "phylum",
      estimatedOrigin: "New Mexico",
    ...
    const kiowaTanoan: LanguageFamily = {
      ...
      name: "Kiowa-Tanoan",
      parentId: null,
      description: "Language phylum including Kiowa and Tanoan languages",
      taxonomicLevel: "phylum",
      estimatedOrigin: "Great Plains and Southwest",
      timeOrigin: "1500+ years ago",
    ...
    const yumanCochimi: LanguageFamily = {
      ...
      name: "Yuman–Cochimí",
      parentId: null,
      description: "Language phylum of the Colorado River region and Baja California",
      taxonomicLevel: "phylum",
      estimatedOrigin: "Colorado River region",
      timeOrigin: "2000+ years ago",
    ...
    const otoManguean: LanguageFamily = {
      ...
      name: "Oto-Manguean",
      parentId: null,
      description: "Large language phylum of central and southern Mexico",
      taxonomicLevel: "phylum",
      estimatedOrigin: "Central Mexico",
      timeOrigin: "6000+ years ago",
    ...
    const mixeZoque: LanguageFamily = {
      ...
      name: "Mixe-Zoque",
      parentId: null,
      description: "Language phylum of southern Mexico",
      taxonomicLevel: "phylum",
      estimatedOrigin: "Southern Mexico",
      timeOrigin: "3500+ years ago",
    ...
    const chibchan: LanguageFamily = {
      ...
      name: "Chibchan",
      parentId: null,
      description: "Language phylum of Central and South America",
      taxonomicLevel: "phylum",
      estimatedOrigin: "Central America",
      timeOrigin: "5000+ years ago",
    ...
    const misumalpan: LanguageFamily = {
      ...
      name: "Misumalpan",
      parentId: null,
      description: "Language phylum of Central America",
      taxonomicLevel: "phylum",
      estimatedOrigin: "Central America",
      timeOrigin: "4000+ years ago",
    ...
    const macroJe: LanguageFamily = {
      ...
      name: "Macro-Jê",
      parentId: null,
      description: "Large language phylum of Brazil",
      taxonomicLevel: "phylum",
      estimatedOrigin: "Central Brazil",
      timeOrigin: "6000+ years ago",
      region: "Brazil",
      totalSpeakers: 250000,
      languageCount: 1,
      createdAt: new Date(),
    };
    ...
    const cariban: LanguageFamily = {
      ...
      name: "Cariban",
      parentId: null,
      description: "Language phylum of northern South America",
      taxonomicLevel: "phylum",
      estimatedOrigin: "Northern South America",
      timeOrigin: "4000+ years ago",
      region: "Venezuela, Guyana, Suriname, Brazil",
      totalSpeakers: 100000,
      languageCount: 1,
      createdAt: new Date(),
    };
    ...
    const aymaran: LanguageFamily = {
      ...
      name: "Aymaran",
      parentId: null,
      description: "Language phylum of the Andes",
      taxonomicLevel: "phylum",
      estimatedOrigin: "Andean highlands",
      timeOrigin: "2500+ years ago",
    ...
    const araucanian: LanguageFamily = {
      ...
      name: "Araucanian",
      parentId: null,
      description: "Language phylum of Chile and Argentina",
      taxonomicLevel: "phylum",
      estimatedOrigin: "Chile",
      timeOrigin: "2000+ years ago",
    ...
    const chonan: LanguageFamily = {
      ...
      name: "Chonan",
      parentId: null,
      description: "Language phylum of Patagonia",
      taxonomicLevel: "phylum",
      estimatedOrigin: "Patagonia",
      timeOrigin: "8000+ years ago",
    ...
    const baltoSlavic: LanguageFamily = {
      ...
      name: "Balto-Slavic",
      parentId: "1",
      description: "Major family of Indo-European including Baltic and Slavic languages",
      taxonomicLevel: "family",
      estimatedOrigin: "Eastern Europe",
      timeOrigin: "3500-3000 BCE",
    ...
    const anatolian: LanguageFamily = {
      ...
      name: "Anatolian",
      parentId: "1",
      description: "Extinct family of Indo-European languages from Anatolia",
      taxonomicLevel: "family",
      estimatedOrigin: "Ancient Anatolia",
      timeOrigin: "3500-1200 BCE",
    ...
    const albanian: LanguageFamily = {
      ...
      name: "Albanian",
      parentId: "1",
      description: "Family of Indo-European with Albanian language",
      taxonomicLevel: "family",
      estimatedOrigin: "Balkans",
      timeOrigin: "1st millennium CE",
      region: "Balkans",
      totalSpeakers: 7500000,
      languageCount: 1,
      createdAt: new Date(),
    };
    ...
    const armenian: LanguageFamily = {
      ...
      name: "Armenian",
      parentId: "1",
      description: "Family of Indo-European with Armenian language",
      taxonomicLevel: "family",
      estimatedOrigin: "Armenian Highlands",
      timeOrigin: "5th century CE",
      region: "Armenian Highlands",
      totalSpeakers: 6700000,
      languageCount: 1,
      createdAt: new Date(),
    };
    ...
    const celtic: LanguageFamily = {
      ...
      name: "Celtic",
      parentId: "1",
      description: "Family of Indo-European languages of Western Europe",
      taxonomicLevel: "family",
      estimatedOrigin: "Central Europe",
      timeOrigin: "1200 BCE",
    ...
    const hellenic: LanguageFamily = {
      ...
      name: "Hellenic",
      parentId: "1",
      description: "Family of Indo-European with Greek languages",
      taxonomicLevel: "family",
      estimatedOrigin: "Greece",
      timeOrigin: "1450 BCE",
      region: "Greece, Cyprus",
      totalSpeakers: 13500000,
      languageCount: 1,
      createdAt: new Date(),
    };
    ...
    const italic: LanguageFamily = {
      ...
      name: "Italic",
      parentId: "1",
      description: "Family of Indo-European languages including Latin and Romance languages",
      taxonomicLevel: "family",
      estimatedOrigin: "Italian Peninsula",
      timeOrigin: "1000 BCE",
    ...
    const tocharian: LanguageFamily = {
      ...
      name: "Tocharian",
      parentId: "1",
      description: "Extinct family of Indo-European from Central Asia",
      taxonomicLevel: "family",
      estimatedOrigin: "Tarim Basin",
      timeOrigin: "200-1000 CE",
