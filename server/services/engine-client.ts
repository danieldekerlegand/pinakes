/**
 * Typed HTTP client for the pinakes-engine FastAPI sidecar.
 *
 * pinakes talks to the shared pinakes-engine graph two ways (see
 * docs/engine-integration.md): the Neo4j TypeScript driver
...
/** Graph-level metrics, mirroring `pinakes_engine.ontology.metrics.to_json`. */
 ...
 * `pinakes_engine.explorer.datalog.DatalogOutcome`. `rows` holds the answer rows,
 ...
 * `pinakes_engine.explorer.live.QueryResult`.
 */
 ...
 * payload (`pinakes_engine.explorer.app._retrieval_payload`): the ranked vector
