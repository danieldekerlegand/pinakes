...
from culturescrape.explorer.live import Neo4jLive, load_queries  # noqa: E402
from culturescrape.neo4j import Neo4jDriverNotInstalled  # noqa: E402
...
def test_console_degrades_when_driver_absent() -> None:
    ...
    assert response.status_code == 200
    assert "culturescrape[neo4j]" in response.text
