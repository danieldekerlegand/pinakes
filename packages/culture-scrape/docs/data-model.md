...
|---|---|
| `csid:ID` | culture-scrape global id (primary key, unique across all nodes) |
...
Relationship `:TYPE` vocabulary (extensible; defined formally in `src/culturescrape/ontology/`):
