...
(`culturescrape.experimental.yago`) that ingests a committed sample, maps its taxonomy
...
[`src/culturescrape/experimental/yago_sample/`](../src/culturescrape/experimental/yago_sample/)
...
```
uv run python -c "import json; from culturescrape.experimental.yago import evaluate; print(json.dumps(evaluate(), indent=2))"
```
...
- Prototype: `src/culturescrape/experimental/yago.py`; sample: `.../yago_sample/`;
