...
This module turns a :class:`~culturescrape.acquire.adapters.SourceAdapter` run
...
from culturescrape.acquire.http import HttpStats
...
LOGGER = logging.getLogger("culturescrape.acquire.run")
