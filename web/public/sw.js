 ...
 *
 * Served verbatim from web/public (it imports nothing). Its routing rules MIRROR
 * web/src/lib/pwa/cache-strategy.ts — that module is the tested source of truth,
