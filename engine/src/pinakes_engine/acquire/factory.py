...
:class:`~pinakes_engine.acquire.http.HttpClient` (built lazily, so a local dump
...
from pinakes_engine.acquire.insimul import InsimulWorldAdapter
from pinakes_engine.acquire.kaikki import KaikkiAdapter
...
from pinakes_engine.acquire.wikitext import WikitextAdapter
