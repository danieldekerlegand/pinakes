...
:class:`~pinakes_engine.ontology.linker.Linker` contract (edges only) does not return,
...
LOGGER = logging.getLogger("pinakes_engine.ontology.genetic")
...
class GeneticLinker(Linker):
    ...
    * *derived_confidence* / *influenced_confidence* / *variant_confidence* — the
    ...
    def link_full(
        ...
        :func:`~pinakes_engine.ontology.run.run_linkers` folds them in by
