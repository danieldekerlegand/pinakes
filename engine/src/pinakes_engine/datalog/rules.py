...
* :data:`INSTANCE_OF` — ``instance_of/2``, the transitive closure of the base
  ...
  above it (see :mod:`pinakes_engine.datalog.taxonomy`).
...
and clauses for a chosen :class:`~pinakes_engine.datalog.Dialect`.
...
from pinakes_engine.datalog import Dialect
...
#: the emitters (:func:`pinakes_engine.datalog.render_program`,
#: :func:`pinakes_engine.datalog.render_souffle_program`).
RULES: tuple[Rule, ...] = (
    ANCESTOR,
    WITHIN_REGION,
    CONTEMPORARY,
