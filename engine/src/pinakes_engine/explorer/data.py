...
from pinakes_engine.ontology.registry import get as get_relation
from pinakes_engine.orchestrate.catalog import Catalog, CatalogEntry, load_catalog
from pinakes_engine.orchestrate.qa import QA_REPORT_SUFFIX
...
def dimension_for(type_: str) -> str:
    ...
    Mirrors how :mod:`pinakes_engine.ontology.metrics` buckets edges, so the graph
