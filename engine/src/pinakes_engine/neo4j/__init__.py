...
The Neo4j converter is the *only* part of pinakes-engine that talks to a graph
...
(``pip install pinakes_engine[neo4j]``) and is imported lazily here — importing
...
class Neo4jDriverNotInstalled(ImportError):
    ...
    def __init__(self) -> None:
        super().__init__(
            ...
            "installed. Install it with: pip install 'pinakes_engine[neo4j]'"
        )
