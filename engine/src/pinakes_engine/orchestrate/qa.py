...
unique — :mod:`pinakes_engine.schema.validate`) yet still be a *bad* scrape: too
...
from pinakes_engine.ontology.metrics import PINAKES_SOURCE, read_dataset
from pinakes_engine.schema.headers import PINAKES_ID_KEY
from pinakes_engine.schema.ids import IdError, normalize_name, normalize_qid
...
#: Delimiter :mod:`pinakes_engine.schema.merge` joins concatenated provenance
...
def _pinakes_provenance_completeness(
    ...
    :data:`~pinakes_engine.ontology.metrics.PINAKES_SOURCE` has lost its
