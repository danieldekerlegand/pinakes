...
pinakes-engine keeps a **lean code repository and publishes data separately.**
...
```sh
pinakes_engine run jobs/seed-corpus.yml      # rebuilds out/seed-corpus/ from scratch
```
...
```sh
pinakes_engine package out/seed-corpus --out dist --name seed-corpus-2026-06
...
[`src/pinakes_engine/orchestrate/package.py`](../src/pinakes_engine/orchestrate/package.py).
