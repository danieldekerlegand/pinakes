...
[`src/pinakes_engine/ontology/registry.py`](../src/pinakes_engine/ontology/registry.py) —
...
- **Structural edges** are emitted during normalization, *before* linking. The
  categorizer ([`schema/categorize.py`](../src/pinakes_engine/schema/categorize.py))
...
- **Inferred edges** are produced by the **linkers**
  ([`ontology/`](../src/pinakes_engine/ontology/)), one per cross-dimensional axis.
  Each linker reads the node and edge sets and returns *new* edges built with
  [`inferred_edge`](../src/pinakes_engine/ontology/linker.py) — which validates the
  `:TYPE` against the registry — stamped `source='inferred:<linker>'` and a
  confidence. The [`Pipeline`](../src/pinakes_engine/ontology/linker.py) runs linkers
...
[`stitch_categories`](../src/pinakes_engine/ontology/stitch.py), so both categories
...
### Geographic — [`geographic.py`](../src/pinakes_engine/ontology/geographic.py)
...
### Temporal — [`temporal.py`](../src/pinakes_engine/ontology/temporal.py)
...
### Linguistic — [`linguistic.py`](../src/pinakes_engine/ontology/linguistic.py)
...
### Genetic / derivation (cultural lineage, not biological) — [`genetic.py`](../src/pinakes_engine/ontology/genetic.py)
...
### Structural / categorical — [`categorize.py`](../src/pinakes_engine/schema/categorize.py)
...
### Structural composition — [`structural.py`](../src/pinakes_engine/ontology/structural.py)
...
[`orchestrate/tiers.py`](../src/pinakes_engine/orchestrate/tiers.py) — local-only,
