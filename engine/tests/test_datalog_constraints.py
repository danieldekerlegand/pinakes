...
* extraction (:mod:`pinakes_engine.acquire.constraints`) of P2302 constraints via a
  fake WDQS lookup, and the corpus resolution baked into the replay artifact;
* translation (:mod:`pinakes_engine.datalog.constraints`) of each constraint type into
...
from pinakes_engine.acquire.constraints import (
    EDGE_PROPERTY_PIDS,
    constraint_query,
...
from pinakes_engine.datalog import Fact, render_program, render_souffle_program
...
from pinakes_engine.datalog.materialize import materialize
...
def test_every_mapped_edge_type_is_registered() -> None:
    from pinakes_engine.ontology import registry
