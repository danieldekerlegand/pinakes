"""Tests for the category generator (``pinakes_engine generate``).
...
from pinakes_engine.acquire import HttpClient, HttpResponse, fetch_count
...
from pinakes_engine.orchestrate.generate import (
    BlueprintError,
    CountFn,
    DumpSource,
    build_specs,
