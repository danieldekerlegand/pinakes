...
* extraction (:mod:`pinakes_engine.acquire.taxonomy`) over both acquisition paths —
  a SPARQL ancestor lookup and a dump-index one — plus the direct-edge reduction;
* projection (:mod:`pinakes_engine.datalog.taxonomy`) of the committed replay
...
from pinakes_engine.acquire.taxonomy import (
    CORPUS_CLASS_QIDS,
    ancestor_query,
