...
dimension fails CI rather than a live ``pinakes_engine run``. As the corpus grows
...
from pinakes_engine.acquire import CategorySpec
from pinakes_engine.acquire.categories import VALID_DIMENSIONS
from pinakes_engine.ontology import validate_type
