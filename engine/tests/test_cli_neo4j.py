...
from pinakes_engine.neo4j import export as export_mod
from pinakes_engine.neo4j import load_csv as load_csv_mod
from pinakes_engine.neo4j.constraints import ENTITY_LABEL
from pinakes_engine.neo4j.export import EDGE_QUERY, NODE_QUERY
...
def test_neo4j_counts_prints_node_and_edge_counts(
    ...
    from pinakes_engine.neo4j import counts as counts_mod
    from pinakes_engine.neo4j.counts import EDGE_COUNT_QUERY, NODE_COUNT_QUERY
