...
:func:`~pinakes_engine.schema.mapper.map_records` → the full linker pipeline
(:func:`~pinakes_engine.ontology.run.run_linkers`) — over the committed fixture
...
from pinakes_engine.acquire import CategorySpec, SourceSpec, WikidataDumpAdapter
from pinakes_engine.ontology import run_linkers, select_linkers
from pinakes_engine.schema.mapper import map_records
