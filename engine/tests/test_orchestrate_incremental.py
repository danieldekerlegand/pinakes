...
entities change. :mod:`pinakes_engine.orchestrate.incremental` diffs a fresher
...
from pinakes_engine.orchestrate.jobs import Job, load_job
...
def test_sync_log_round_trips_watermark_and_last_sync(tmp_path: Path) -> None:
    ...
    from pinakes_engine.orchestrate.incremental import UpsertResult
