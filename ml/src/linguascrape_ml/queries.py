...
:func:`linguascrape_ml.consistency.load_edge_constraints` /
:func:`~linguascrape_ml.consistency.node_type_of`). An entity's type is read off its
...
MLflow logging live in the thin CLI :mod:`linguascrape_ml.export_queries`.
"""
...
from linguascrape_ml.consistency import EdgeConstraint, node_type_of
